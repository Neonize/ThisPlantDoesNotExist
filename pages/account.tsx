        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
            ...
            <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">
              We know that most websites just want your data. We normally dont,
              but the following features are only possible with an account.
            </p>
          </div>
          <div className="grid xl:grid-cols-6 md:grid-cols-4 grid-cols-2 gap-3">
            ...
            <div className="col-span-2 border border-gray-200 p-6 rounded-lg">
              ...
              <p className="leading-relaxed text-base">
                Tweak your plants however you like. Change the description,
                title or other fields after generation
              </p>
            </div>
            <div className="col-span-2 border border-gray-200 p-6 rounded-lg">
              <div className="flex justify-between items-center mb-4">
              ...
              <p className="leading-relaxed text-base">
                Get an easy to use overview over all your generated images in
                your account space
              </p>
            </div>
            <div className="xl:col-span-3 col-span-2 border border-gray-200 p-6 rounded-lg">
              ...
              <p className="leading-relaxed text-base">
                You want more features or have a nice idea? With an account you
            ...
            <div className="xl:col-span-3 col-span-2 border border-gray-200 p-6 rounded-lg">
              ...
              <p className="leading-relaxed text-base">
                With an account you can hide every plant you created from the
                public
              </p>
            </div>
          </div>
